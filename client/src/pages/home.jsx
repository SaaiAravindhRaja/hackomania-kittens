...
export default function Home() {
  ...
  useEffect(() => {
    get('/stats').then(s => setStats(s)).catch(() => {})
  }, [])
    ...
    <div className="grain-overlay relative min-h-screen overflow-hidden bg-[#070a0d] text-white">
      ...
      <div className="relative z-10">
        ...
        <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-7">
          ...
          <motion.div {...fadeUp(0.05)} className="flex items-center gap-1.5">
            <Link
              to="/login"
        ...
        <section className="mx-auto max-w-6xl px-6 pb-12 pt-12 lg:pt-20">
          ...
          {/* Big headline — serif italic + sans bold contrast */}
          ...
          <motion.p {...fadeUp(0.25)} className="mb-10 max-w-xl text-base leading-relaxed text-slate-400 lg:text-lg">
          ...
          <motion.div {...fadeUp(0.3)} className="flex flex-wrap gap-3">
            <Link
              to="/register"
              className="group flex items-center gap-2 rounded-xl bg-emerald-600 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-emerald-950 transition-all duration-300 hover:bg-emerald-500 hover:shadow-[0_0_30px_rgba(52,211,153,0.35)] hover:scale-[1.02]"
            >
              Start contributing
          ...
          <motion.div
            ...
            className="mt-16 flex flex-wrap items-center gap-x-12 gap-y-5 border-t border-slate-800/70 pt-10"
          >
            <StatPill
              label="Total raised"
